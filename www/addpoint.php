...
*/
	...
	$query1 = "INSERT INTO registered_items(type, date, time, username, description, picture, geom) VALUES ('$type', '$date', '$time', '$username', '$description', '$picture', ST_GeomFromText('POINT($varlat $varlng)', 4326))";
  ...
  pg_close();
	...
	header("Location: capturing_form.html");
	exit;
?>
